...
return [
    ...
    'GET    /api/quizzes/powerups/list' => 'api/quizzes/powerups/list.php',
    'POST   /api/quizzes/powerups/redeem' => 'api/quizzes/powerups/redeem.php',
    'POST   /api/quizzes/powerups/activate' => 'api/quizzes/powerups/activate.php',
    'GET    /api/quizzes/powerups/state' => 'api/quizzes/powerups/state.php',
    'GET    /api/quizzes/hint/dictionary' => 'api/quizzes/hint/dictionary.php',
    ...
    'POST /api/pc/discovery-sync' => 'api/pc/discovery-sync.php',
    'POST /api/pc/discover' => 'api/pc/discover.php',
    'GET  /api/pc/unassigned' => 'api/pc/unassigned.php',
    'POST /api/pc/assign' => 'api/pc/assign.php',
    'POST /api/pc/unassign' => 'api/pc/unassign.php',
    'GET  /api/pc/deploy-evaluate' => 'api/pc/deploy-evaluate.php',
    'POST /api/pc/deploy-policy' => 'api/pc/deploy-policy.php',
    'POST /api/pc/deploy-queue' => 'api/pc/deploy-queue.php',
    'POST /api/pc/deploy-retry' => 'api/pc/deploy-retry.php',
    'POST /api/pc/deploy-run' => 'api/pc/deploy-run.php',
    'GET  /api/pc/deploy-status' => 'api/pc/deploy-status.php',
    'POST /api/pc/update-queue' => 'api/pc/update-queue.php',
    'POST /api/pc/update-run' => 'api/pc/update-run.php',
    'POST /api/pc/update-retry' => 'api/pc/update-retry.php',
    'GET  /api/pc/update-status' => 'api/pc/update-status.php',
    'GET  /api/pc/debug-events' => 'api/pc/debug-events.php',
