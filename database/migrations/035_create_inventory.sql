...
CREATE TABLE IF NOT EXISTS inventory_items (
    ...
    lab_id INT DEFAULT NULL COMMENT 'Lab where item is located',
    floor_id INT DEFAULT NULL COMMENT 'Floor where item is located',
    station_id INT DEFAULT NULL COMMENT 'Station/item assignment',
    assigned_to INT DEFAULT NULL COMMENT 'User currently using the item',
