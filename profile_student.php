...
<body>
    <nav class="sidebar">
        ...
        <div class="sidebar-nav">
            <a href="dashboard_student.php"><i class="bi bi-grid-1x2"></i> Dashboard</a>
            ...
            <a href="profile_student.php" class="active"><i class="bi bi-person"></i> My Profile</a>
    ...
    <div class="main-content">
        ...
        <div class="row g-4">
                ...
                <div class="xp-card text-center">
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <div class="stat-box">
                                    <div class="value text-primary"><?= number_format($user['total_points']) ?></div>
                                    <div class="label">Points</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="stat-box">
                                    <div class="value text-warning"><?= $user['current_streak'] ?>🔥</div>
                                    <div class="label">Streak</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="stat-box">
                                    <div class="value"><?= $user['quizzes_taken'] ?></div>
                                    <div class="label">Quizzes</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="stat-box">
                                    <div class="value"><?= $user['assignments_completed'] ?></div>
            ...
            <div class="col-md-8">
                ...
                <div class="xp-card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-journal-check me-2"></i>Recent Quizzes</h5>
                    </div>
                    <div class="card-body p-0">
                        ...
                        <div class="activity-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="fw-semibold"><?= e($q['quiz_title']) ?></div>
                                    <div class="text-muted small"><?= $q['finished_at'] ? date('M j, Y', strtotime($q['finished_at'])) : '' ?></div>
                                </div>
                                <div class="text-end">
                                    <div class="fw-bold <?= $q['score_percentage'] >= 80 ? 'text-success' : ($q['score_percentage'] >= 50 ? 'text-warning' : 'text-danger') ?>">
                                        <?= number_format($q['score_percentage'], 1) ?>%
                                    </div>
                                    <div class="text-muted small"><?= $q['correct_answers'] ?>/<?= $q['total_questions'] ?> correct</div>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                ...
                <div class="xp-card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-upload me-2"></i>Recent Submissions</h5>
                    </div>
                    <div class="card-body p-0">
                        ...
                        <div class="activity-item px-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="fw-semibold"><?= e($s['assignment_title']) ?></div>
                                    <div class="text-muted small"><?= $s['submitted_at'] ? date('M j, Y', strtotime($s['submitted_at'])) : '' ?></div>
                                </div>
                                <div class="text-end">
                                    <?php if ($s['status'] === 'graded'): ?>
                                    <span class="badge bg-success"><?= number_format($s['grade'], 1) ?>/<?= $s['max_points'] ?></span>
                                    <?php elseif ($s['is_late']): ?>
